...
const spacetimedb = schema({
	...
	storage: table({ public: true }, {
		owner_key: t.string().primaryKey(),
		value: t.string()
	}),
	published: table({ public: true }, {
		owner: t.string(),
		module: t.string(),
		version: t.string()
	})
...
const checkAuth = (c, owner, passhash) => {
...
const publish = spacetimedb.procedure({
	owner: t.string(),
	passhash: t.string(),
	module: t.string(),
	version: t.string(),
	del: t.bool()
}, t.enum("publishResult", ["success", "err"]), (ctx, { owner, passhash, module, version, del }) => ctx.withTx((c) => {
	if (!checkAuth(c, owner, passhash)) return err;
	if (del) c.db.published.delete({
		owner,
		module,
		version
	});
	else c.db.published.insert({
		owner,
		module,
		version
	});
